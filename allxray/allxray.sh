...
clear
echo -e "   \e[$line════════════════════════════════════════\e[m"
echo -e "   \e[$back_text             \e[30m═[\e[$box MENU ALL XRAY\e[30m ]═          \e[m"
echo -e "   \e[$line════════════════════════════════════════\e[m"
echo -e ""
echo -e " ${GB}[1]${NC} ${YB}Create Account${NC} "
echo -e " ${GB}[2]${NC} ${YB}Trial Account${NC} "
echo -e " ${GB}[3]${NC} ${YB}Extend Account${NC} "
echo -e " ${GB}[4]${NC} ${YB}Delete Account${NC} "
