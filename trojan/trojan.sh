...
echo -e "   \e[$number (•3)\e[m \e[$below Extending Account Trojan Active Life\e[m"
echo -e "   \e[$number (•4)\e[m \e[$below Delete Account Trojan\e[m"
echo -e "   \e[$number (•5)\e[m \e[$below Check User Login Trojan\e[m"
echo -e "   \e[$line════════════════════════════════════════\e[m"
