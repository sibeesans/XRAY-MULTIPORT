...
clear
echo -e "${RB}————————————————————————————————————————————————————————${NC}"
echo -e "               ${GB}----- [ Trojan Menu ] -----${NC}              "
echo -e "${RB}————————————————————————————————————————————————————————${NC}"
echo -e ""
echo -e " ${GB}[1]${NC} ${YB}Create Account Trojan${NC} "
echo -e " ${GB}[2]${NC} ${YB}Trial Account Trojan${NC} "
echo -e " ${GB}[3]${NC} ${YB}Extend Account Trojan${NC} "
echo -e " ${GB}[4]${NC} ${YB}Delete Account Trojan${NC} "
