...
echo -e "  \e[$number (•2)\e[m \e[$below VMESS MENU & WS\e[m    \e[$number (•6)\e[m \e[$below SOWDOWSOK\e[m"
echo -e "  \e[$number (•3)\e[m \e[$below VLESS MENU & WS\e[m    \e[$number (•7)\e[m \e[$below MENU SOCKS5\e[m"  
echo -e "  \e[$number (•4)\e[m \e[$below TROJAN MENU & WS\e[m   \e[$number (•8)\e[m \e[$below WIREGUARD\e[m"
echo -e " \e[$line╒════════════════════════════════════════════════════════════╕\e[m"
...
echo -e "  \e[$number (17)\e[m \e[$below MENU BUAT SEMUA XRAY\e[m \e[$number (18)\e[m \e[$below INSTALL UDP\e[m"
echo -e ""
