...
#install cf
wget https://raw.githubusercontent.com/${GitUser}/XRAY-MULTIPORT/main/install/cf.sh && chmod +x cf.sh && ./cf.sh
rm -f /root/cf.sh
clear
else
...
sleep 1
wget https://raw.githubusercontent.com/${GitUser}/XRAY-MULTIPORT/main/install/ssh-vpn.sh && chmod +x ssh-vpn.sh && screen -S ssh-vpn ./ssh-vpn.sh
...
sleep 1
wget https://raw.githubusercontent.com/${GitUser}/XRAY-MULTIPORT/main/install/ohp.sh && chmod +x ohp.sh && ./ohp.sh
wget https://raw.githubusercontent.com/${GitUser}/XRAY-MULTIPORT/main/install/ohp-dropbear.sh && chmod +x ohp-dropbear.sh && ./ohp-dropbear.sh
wget https://raw.githubusercontent.com/${GitUser}/XRAY-MULTIPORT/main/install/ohp-ssh.sh && chmod +x ohp-ssh.sh && ./ohp-ssh.sh
echo -e "\e[0;32mDONE INSTALLING OHP PORT\e[0m"
clear
#install websocket
echo -e "\e[0;32mINSTALLING WEBSOCKET PORT...\e[0m"
wget https://raw.githubusercontent.com/${GitUser}/XRAY-MULTIPORT/main/websocket-python/websocket.sh && chmod +x websocket.sh && screen -S websocket.sh ./websocket.sh
...
echo "   - Shadowsocks 2022 TLS    : 443" | tee -a log-install.txt
echo "   - Shadowsocks 2022 No TLS : 80" | tee -a log-install.txt
echo "   - Shadowsocks 2022 GRPC   : 443" | tee -a log-install.txt
...
echo -e "    \e[1;32m|         PREMIUM BY JengkolOnline          |\e[0m"
echo -e "    \e[1;32m'------------------------------------------'\e[0m"
echo ""
