...
#xray-vless-xtls
                ...
                "fallbacks": [
                    ...
                    {
                        "path": "/pelangisenja-vlesswstls", # // VMESS WS TLS
                        "dest": 1212,
                        "xver": 1
                    },
                    {
                        "path": "/pelangisenja-vmesswstls", # // VLESS WS TLS
                        "dest": 1213,
                        "xver": 1
                    },
                    {
                        "path": "/pelangisenja-trojanwstls", # // TROJAN WS TLS
                        "dest": 1214,
                        "xver": 1
                    }
                ]
...
#xray-trojan-nontls
       ...
       "streamSettings":{
           ...
           "wsSettings": {
             "acceptProxyProtocol": true,
               "path": "/pelangisenja-trojanwsntls"
             }
          }
       }
    ],
  ...
  "inbounds": [
      ...
      "settings": {
        ...
        "fallbacks": [
          ...
          {
            "path": "/pelangisenja-vlesswsntls", # // VLESS NONE
            "dest": 1301,
            "xver": 1
          },
          {
            "path": "/pelangisenja-vmesswsntls", # // VMESS NONE
            "dest": 1302,
            "xver": 1
          },
          {
             "path": "/pelangisenja-trojanwsntls", # // TROJAN NONE
            "dest": 1303,
            "xver": 1
          }
        ]
