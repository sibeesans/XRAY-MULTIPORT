...
clear
echo -e "${RB}————————————————————————————————————————————————————————${NC}"
echo -e "               ${GB}----- [ Vless Menu ] -----${NC}               "
echo -e "${RB}————————————————————————————————————————————————————————${NC}"
echo -e ""
echo -e " ${GB}[1]${NC} ${YB}Create Account Vless${NC} "
echo -e " ${GB}[2]${NC} ${YB}Trial Account Vless${NC} "
echo -e " ${GB}[3]${NC} ${YB}Extend Account Vless${NC} "
echo -e " ${GB}[4]${NC} ${YB}Delete Account Vless${NC} "
